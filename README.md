# Sarah AI: Command Center (Admin Dashboard)

A premium, high-fidelity administrative dashboard built for managing multi-tenant AI Voice Agents. Sarah AI Command Center utilizes a **Glassmorphism Design System** to provide real-time operational control with a sleek, modern aesthetic.
...
> [!TIP]
> This dashboard is designed to work in tandem with the [Sarah AI Backend](../ai_voice_agent/ai_voice_agent_app/README.md). Ensure the backend is running and exposed via localtunnel before launching the UI.
